...
def tracking_data_modal(request: HttpRequest, pk: int) -> TemplateResponse:
    ...
    form = TrackingDataViewForm(initial={
        ...
        'organization': tracking_data.ip_data.getSelectedOrganization() if tracking_data.ip_data else None,
        ...
        'country': tracking_data.ip_data.getSelectedCountryName() if tracking_data.ip_data else None,
